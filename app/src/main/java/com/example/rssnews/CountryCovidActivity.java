...
public class CountryCovidActivity extends AppCompatActivity{
    ...
    private CountryCovidAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CountryCovidAdapter(this,list);
        ...
        ApiUtilities.getApiInterface().getCountryData().enqueue(new Callback<List<CountryData>>() {
            ...
            public void onFailure(Call<List<CountryData>> call, Throwable t) {
                dialog.dismiss();
                Toast.makeText(CountryCovidActivity.this,""+t.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
